    ...
    <section className="skills" id="skills">
      ...
      <div className="container d-flex justify-content-evenly">
        <div className="container text-center me-5">
          ...
          <img src="https://skillicons.dev/icons?i=c,cpp,py,html,css,js,mongodb,django,flutter,dart,firebase,md,nextjs,redis,redux,regex,jquery,express,tensorflow,nodejs,tailwind,bootstrap,react,figma&theme=dark&perline=6" alt="" />
        </div>
...
<img src="https://skillicons.dev/icons?i=vscode,codepen,cloudflare,netlify,unity,materialui,raspberrypi,androidstudio,wordpress,githubactions,svg,heroku,arduino,vercel,git,ps,linux,pr,github&theme=dark&perline=6" alt="" />
        </div>
      </div>
